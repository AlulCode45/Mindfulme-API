...
return [
    ...
    'allowed_origins' => ['http://localhost:8080', 'http://localhost:8081', 'http://localhost:8082', 'http://localhost:8083', 'https://mindfulme.pusatandalan.com', 'https://app-mindfulme.pusatandalan.com'],
